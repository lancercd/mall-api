...
public class RegexUtil {
     ...
     * Regex of image url
     */
    public static final String REGEX_IMAGE_URL = "^((http|https):\\/\\/)(?:[a-zA-Z]|[0-9]|[$-_@.&+]|[!*\\(\\),]|(?:%[0-9a-fA-F][0-9a-fA-F]))+(.png|.jpg|.gif|.bmp|.psd|.tiff|.tga|.eps)$";
    ...
    /**
     * Return whether input matches regex of image url
     *
     * @param input The input.
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isImageUrl(final CharSequence input) {
        return isMatch(REGEX_IMAGE_URL, input);
    }
