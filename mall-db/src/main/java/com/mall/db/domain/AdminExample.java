...
public class AdminExample {
    ...
    public AdminExample distinct(boolean distinct) {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addRoleIdsCriterion(String condition, Object value, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value, "com.mall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addRoleIdsCriterion(String condition, Integer[] value1, Integer[] value2, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value1, value2, "com.mall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
    ...
    public interface IExampleWhen {
        void example(com.mall.db.domain.AdminExample example);
    }
}